...
class NTU_Feeder(Dataset):
    def __init__(self, phase, dataset, split, root_folder, inputs='JVBM',
                 num_frame=288, connect_joint=[], debug=False, graph='mutual',
                 random_swap=False, processing='symmetry', crop=False, transform=False, **kwargs):
        self.T = num_frame
        self.inputs = inputs
